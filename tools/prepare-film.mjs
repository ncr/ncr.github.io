...
import fs from 'node:fs';import path from 'node:path';import * as THREE from '../site/node_modules/three/build/three.module.js';
...
const read=p=>JSON.parse(fs.readFileSync(path.join(root,p))),score=read('site/src/data/drawing-score.json');
...
console.log('Prepared 42 geometries, 43 camera/pen tables and merged nozzle:',(bytes/1048576).toFixed(2),'MiB');
