...
print('Overview holds:',round(min(s['end']-s['start']-s['holdStart'] for s in score),2),'to',round(max(s['end']-s['start']-s['holdStart'] for s in score),2),'seconds; soundtrack unchanged')
